...
if (isset($_POST['tambah'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $insert_query = "INSERT INTO barang (nama_barang, stok) VALUES ('$nama_barang', '$stok')";
...
if (isset($_POST['edit'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $update_query = "UPDATE barang SET nama_barang = '$nama_barang', stok = '$stok' WHERE id_barang = '$id_barang'";
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-warning btn-sm" onclick="editBarang(<?php echo $row['id_barang']; ?>, '<?php echo htmlspecialchars($row['nama_barang']); ?>', <?php echo $row['stok']; ?>)">Edit</button>
